...
- `spark.app.id`: `local-1763115932138`
- `spark.app.name`: `BDA - Environment Check`
- `spark.app.startTime`: `1763115932088`
- `spark.app.submitTime`: `1763115667287`
